        ...
        <div className="min-h-[100vh] w-full relative">
                <div className="fixed inset-0 flex items-center  justify-center bg-black bg-opacity-50 backdrop-blur-sm z-50">
                    ...
                    <button onClick={() => skipSetup()} className="font-poppins font-medium text-base absolute top-4 right-2 text-gray-400 underline hover:text-gray-600 ">Skip for now</button>
                        ...
                        <button onClick={() => navigate('/setup/sleep')} className="px-4 py-1 bg-blue-500 text-white rounded-md absolute right-2 bottom-2 text-lg font-poppins font-normal hover:bg-blue-600">Next</button>
                        <button onClick={() => navigate('/setup/food')} className="px-4 py-1 bg-blue-500 text-white rounded-md absolute left-2 bottom-2 text-lg font-poppins font-normal hover:bg-blue-600">Back</button>
                    </div>
                </div>
