  ...
  return (
    <div className="relative" ref={dropdownRef}>
        <motion.button
            ...
            className="flex items-center justify-between w-full px-3 py-2 bg-indigo-100 border border-indigo-400 rounded-full shadow-sm text-sm font-medium text-indigo-700 hover:bg-indigo-200 hover:text-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out"
        >
            Sign in
        </motion.button>
...
export function NotLogedTopCategories({ selectedTimeRange, onTimeRangeChange, selectedAction, onActionChange, selectedCategory, onCategoryChange }) {
  const navigate = useNavigate();
